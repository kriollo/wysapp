...
final class Strings extends \Twig_Extension {
  ...
  */
  ...
  /**
   * Fuerza la salida de un array o string en UTF8
   *
   * @param  : Array o Texto para Forzar a UTF8
   * 
   * @return : Array o Texto en formato UTF8
   */
  public static function force_utf8_output($dat) {
